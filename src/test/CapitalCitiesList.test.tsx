...
test('should render city names', () => {
	const cityNames = ["test city 1", "test city 2", "test city 3"];
	const selectedCity = cityNames[1];

	render(<CapitalCitiesList cities={cityNames} selectedCity={selectedCity} onClick={() => { }} />);
...
test("should highlight selected city name", () => {
	const cityNames = ['test city 1', 'test city 2', 'test city 3'];
	const selectedCity = cityNames[1];
...
test("should return selected city name when clicked", () => {
	const cityNames = ['test city 1', 'test city 2', 'test city 3'];
	const selectedCity = cityNames[1];
	const handleClick = jest.fn();

	render(<CapitalCitiesList cities={cityNames} selectedCity={selectedCity} onClick={handleClick} />);
...
test("should expand/collapse in mobile when clicked", () => {
	const cityNames = ['test city 1', 'test city 2', 'test city 3'];
	const selectedCity = cityNames[1];
